...
public class HttpClient {
    ...
    static final int connectionRequestTimeout = 1000;// ms毫秒,从池中获取链接超时时间
    static final int connectTimeout = 1000;// ms毫秒,建立链接超时时间
    static final int socketTimeout = 1000;// ms毫秒,读取超时时间
